...
StateGameOver::StateGameOver(ExampleGame* pOwner, TTF_Font* pFont)
    : m_pOwner(pOwner)
    , m_gameObjects()
{
    //Create objects for GameOver screen
    //Text and buttons
    m_gameObjects.push_back(new UITextField(pFont, "Game Over", SDL_Color{ 255, 255, 255 }, Vector2{ 350, 100 }, pOwner->GetGame()->GetRenderer(), 1000));
    ...
    UIButton* pPlayButton = new UIButton(SDL_Rect{ 325,150,150,100 }, pOwner->GetGame()->GetRenderer(),
    ...
    UIButton* pCredits = new UIButton(SDL_Rect{ 325,450,150,100 }, pOwner->GetGame()->GetRenderer(),
    ...
    UIButton* pQuitButton = new UIButton(SDL_Rect{ 325, 300, 150, 100 }, pOwner->GetGame()->GetRenderer(),
...
void StateGameOver::Render(SDL_Renderer* pRenderer)
{
...
bool StateGameOver::HandleEvent(SDL_Event* pEvent)
{
    switch (pEvent->type)
    {
...
void StateGameOver::ChangeButtonFocus(int direction)
{
